        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)->addIndexColumn()
                ...
                ->addColumn('action', function($row){
                    ...
                    if (check_user_access('locations', 'delete')) {
                        $del_btn = '<a href="javascript:void(0);" class="action-icon" onclick="return delete_location('.$row->id.')"> <i class="mdi mdi-delete"></i></a>';
                    }
