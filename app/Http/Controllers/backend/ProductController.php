        ...
        if ($request->ajax()) {
            ...
            ->addColumn('image', function($row){
                ...
                ->addColumn('action', function($row){
                    ...
                    if (check_user_access('products', 'delete')) {
                        $del_btn = '<a href="javascript:void(0);" class="action-icon" onclick="return delete_product('.$row->id.')"> <i class="mdi mdi-delete"></i></a>';
                    }
